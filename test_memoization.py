...
def test_args_and_kwargs_memoization():
    assert get_random_with_args_and_kwargs(1, n=2) == get_random_with_args_and_kwargs(1, n=2)
    assert get_random_with_args_and_kwargs(1, n=2) != get_random_with_args_and_kwargs(1, n=3)
    assert get_random_with_args_and_kwargs(1, n=2) != get_random_with_args_and_kwargs(2, n=2)
